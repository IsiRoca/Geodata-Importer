...
LOAD DATA LOCAL INFILE './././download/geolite/city/GeoLite2-City-Locations-es.csv'
...
LOAD DATA LOCAL INFILE './././download/geolite/country/GeoLite2-Country-Locations-es.csv'
